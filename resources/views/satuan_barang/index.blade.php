                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td align="right"><a href="{{route('satuan_barang.edit', ['id'=>$row->id])}}" class="btn btn-success btn-sm" role="button">Edit</a> <a href="#" class="btn btn-danger btn-sm hapus" data-id="{{$row->id}}" role="button">Delete</a></td>
                            </tr>
                            @endforeach
                        </table>
                    </div>
